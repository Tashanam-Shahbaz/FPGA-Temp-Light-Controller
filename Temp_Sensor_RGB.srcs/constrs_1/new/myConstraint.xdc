...
##Buttons: BTNC Button --> N17 on FPGA
...
##Temperature Senosr if on or not.
set_property -dict { PACKAGE_PIN U12   IOSTANDARD LVCMOS33 } [get_ports { isTempSensor }]; #IO_L20P_T3_A08_D24_14 Sch=sw[13]
